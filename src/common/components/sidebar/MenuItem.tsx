...
const MenuItem = ({
  ...
  const activeClasses = `flex items-center gap-2 py-2 px-4 font-medium text-neutral-700 dark:text-neutral-400 hover:text-neutral-900 hover:dark:text-neutral-300 rounded-lg group ${
