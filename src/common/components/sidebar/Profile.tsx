...
const Profile = () => {
  ...
  return (
    <MenuContext.Provider value={{ hideNavbar }}>
      <div
        className={clsx(
          'z-10 fixed lg:relative shadow-sm xl:shadow-none lg:border-none dark:border-b dark:border-neutral-800 bg-light dark:bg-dark lg:!bg-transparent w-full p-5 lg:p-0',
          expandMenu && 'pb-0'
        )}
      >
